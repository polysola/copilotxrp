  ...
  return (
    <div className="text-center">
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              Copilot AI has been integrated into the XRP Ledger. 
              </p>
              <div className="mt-10 flex flex-col items-center justify-center gap-8">
      <div className="w-full flex flex-col lg:flex-row items-center justify-center gap-6">
        <Link href="/tools">
          <Button className="text-white gradient-btn w-full lg:w-auto" size="lg">
            XRPL Tools
          </Button>
        </Link>
      ...
      <div className="flex items-center justify-center gap-4">
        <a href="https://x.com/CopilotXRP" className="text-sm font-semibold leading-6 text-gray-400">
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
            <path fill="#03a9f4" d="M24,4C12.954,4,4,12.954,4,24s8.954,20,20,20s20-8.954,20-20S35.066,4,24,4z"></path>
        ...
        <a href="https://t.me/CopilotXRP_Portal" className="text-sm font-semibold leading-6 text-gray-400">
          <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
